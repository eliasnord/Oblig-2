...
public class Dispatcher extends Stopable {
	...
	public void dispatch(ClientSession client, Message msg) {
		...
		case CREATETOPIC:
			onCreateTopic((CreateTopicMsg) msg, null);
			break;
	...
	public void onCreateTopic(CreateTopicMsg msg, Connection connection) {
	...
	public void onPublish(PublishMsg msg) {
		...
		for (String user : subscribers) {
			if (storage.isLinked(user) && storage.getSession(user) != null) {
				storage.getSession(user).send(msg);
			} else {
				storage.addToBuffer(user, msg);
